...
### 7.1 Roteiro Sugerido (15 minutos)

| Tempo | Conteúdo |
|-------|----------|
| 0-2min | Introdução: o que é o sistema e qual o objetivo do trabalho |
| 2-5min | Etapa 1: Requisitos levantados (RF, RNF, RN) |
| 5-7min | Etapa 2/3: Plano de testes e casos de teste |
| 7-10min | Demo ao vivo: demonstrar o sistema funcionando |
| 10-13min | Etapa 4: Executar testes automatizados ao vivo |
| 13-15min | Resultados, conclusões e melhorias identificadas |

### 7.2 Demo ao Vivo

**Antes de apresentar, rodar:**
```bash
# Terminal 1
...
**Fluxo da demo:**
1. Mostrar tela de registro → criar conta
2. Fazer login
3. Criar 3 tarefas
4. Marcar uma como concluída
5. Editar uma tarefa
6. Excluir uma tarefa
7. Fazer logout

**Executar testes automatizados ao vivo:**
```bash
# Terminal 1 — backend em modo teste
cd backend && NODE_ENV=test npm run dev
